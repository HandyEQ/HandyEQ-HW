...
set_property PACKAGE_PIN K2 [get_ports {drdy_board_out}]					
    set_property IOSTANDARD LVCMOS33 [get_ports {drdy_board_out}]
#Bank = 35, Pin name = IO_L6P_T0_35,						Sch name = JC2
set_property PACKAGE_PIN E7 [get_ports {eoc_board_out}]					
    set_property IOSTANDARD LVCMOS33 [get_ports {eoc_board_out}]
##Bank = 35, Pin name = IO_L22P_T3_35,						Sch name = JC3
#set_property PACKAGE_PIN J3 [get_ports {eos_board_out}]					
#    set_property IOSTANDARD LVCMOS33 [get_ports {eos_board_out}]
#Bank = 35, Pin name = IO_L21P_T3_DQS_35,					Sch name = JC4
set_property PACKAGE_PIN J4 [get_ports {decimator4_done_board_out}]					
    set_property IOSTANDARD LVCMOS33 [get_ports {decimator4_done_board_out}]
#Bank = 35, Pin name = IO_L23N_T3_35,						Sch name = JC7
set_property PACKAGE_PIN K1 [get_ports {eos_board_out}]					
    set_property IOSTANDARD LVCMOS33 [get_ports {eos_board_out}]
