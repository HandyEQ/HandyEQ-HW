...
architecture arch of IIR_Biquad_3 is
...
--
	...
	constant	Coef_b0	:	std_logic_vector(31 downto 0) := f3_b0;				-- b0		~ +0.2225548
	constant	Coef_b1	:	std_logic_vector(31 downto 0) := f3_b1;				-- b1		~ +0.4451095
	constant	Coef_b2	:	std_logic_vector(31 downto 0) := f3_b2;				-- b2		~ +0.2225548	

	constant	Coef_a1	:	std_logic_vector(31 downto 0) := f3_a1;				-- a1		~ -0.3372905 	
	constant	Coef_a2	:	std_logic_vector(31 downto 0) := f3_a2;
