...
set_property PACKAGE_PIN K5 [get_ports {colorLEDs[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {colorLEDs[0]}]
#Bank = 15, Pin name = IO_L5P_T0_AD9P_15,					Sch name = LED16_G
set_property PACKAGE_PIN F13 [get_ports {colorLEDs[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {colorLEDs[1]}]
#Bank = 35, Pin name = IO_L19N_T3_VREF_35,					Sch name = LED16_B
set_property PACKAGE_PIN F6 [get_ports {colorLEDs[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {colorLEDs[2]}]
#Bank = 34, Pin name = IO_0_34,							Sch name = LED17_R
set_property PACKAGE_PIN K6 [get_ports {colorLEDs[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {colorLEDs[3]}]
#Bank = 35, Pin name = IO_24P_T3_35,						Sch name =  LED17_G
set_property PACKAGE_PIN H6 [get_ports {colorLEDs[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {colorLEDs[4]}]
#Bank = CONFIG, Pin name = IO_L3N_T0_DQS_EMCCLK_14,				Sch name = LED17_B
set_property PACKAGE_PIN L16 [get_ports {colorLEDs[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {colorLEDs[5]}]
...
set_property PACKAGE_PIN N6 [get_ports {sevenSeg[8]}]
set_property IOSTANDARD LVCMOS33 [get_ports {sevenSeg[8]}]
#Bank = 34, Pin name = IO_L18P_T2_34,						Sch name = AN1
set_property PACKAGE_PIN M6 [get_ports {sevenSeg[9]}]
set_property IOSTANDARD LVCMOS33 [get_ports {sevenSeg[9]}]
#Bank = 34, Pin name = IO_L4P_T0_34,						Sch name = AN2
set_property PACKAGE_PIN M3 [get_ports {sevenSeg[10]}]
set_property IOSTANDARD LVCMOS33 [get_ports {sevenSeg[10]}]
#Bank = 34, Pin name = IO_L13_T2_MRCC_34,					Sch name = AN3
set_property PACKAGE_PIN N5 [get_ports {sevenSeg[11]}]
set_property IOSTANDARD LVCMOS33 [get_ports {sevenSeg[11]}]
#Bank = 34, Pin name = IO_L3P_T0_DQS_34,					Sch name = AN4
set_property PACKAGE_PIN N2 [get_ports {sevenSeg[12]}]
set_property IOSTANDARD LVCMOS33 [get_ports {sevenSeg[12]}]
#Bank = 34, Pin name = IO_L16N_T2_34,						Sch name = AN5
set_property PACKAGE_PIN N4 [get_ports {sevenSeg[13]}]
set_property IOSTANDARD LVCMOS33 [get_ports {sevenSeg[13]}]
#Bank = 34, Pin name = IO_L1P_T0_34,						Sch name = AN6
set_property PACKAGE_PIN L1 [get_ports {sevenSeg[14]}]
set_property IOSTANDARD LVCMOS33 [get_ports {sevenSeg[14]}]
#Bank = 34, Pin name = IO_L1N_T034,						Sch name = AN7
set_property PACKAGE_PIN M1 [get_ports {sevenSeg[15]}]
set_property IOSTANDARD LVCMOS33 [get_ports {sevenSeg[15]}]
...
##Pmod Header JA
#Bank = 15, Pin name = IO_L1N_T0_AD0N_15,					Sch name = JA1 spisel
set_property PACKAGE_PIN B13 [get_ports {OLED[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {OLED[0]}]
#Bank = 15, Pin name = IO_L5N_T0_AD9N_15,					Sch name = JA2 gpioDisplayEnc[5]
set_property PACKAGE_PIN F14 [get_ports mosi]
set_property IOSTANDARD LVCMOS33 [get_ports mosi]
#Bank = 15, Pin name = IO_L16N_T2_A27_15,					Sch name = JA3 gpioDisplayEnc[6]
set_property PACKAGE_PIN D17 [get_ports miso]
set_property IOSTANDARD LVCMOS33 [get_ports miso]
#Bank = 15, Pin name = IO_L16P_T2_A28_15,					Sch name = JA4 gpioDisplayEnc[7]
set_property PACKAGE_PIN E17 [get_ports sck]
set_property IOSTANDARD LVCMOS33 [get_ports sck]
#Bank = 15, Pin name = IO_0_15,							Sch name = JA7
set_property PACKAGE_PIN G13 [get_ports {OLED[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {OLED[1]}]
#Bank = 15, Pin name = IO_L20N_T3_A19_15,					Sch name = JA8
set_property PACKAGE_PIN C17 [get_ports {OLED[2]}]
...
set_property PACKAGE_PIN E18 [get_ports {OLED[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {OLED[4]}]



##Pmod Header JB
#Bank = 15, Pin name = IO_L15N_T2_DQS_ADV_B_15,					Sch name = JB1 spisel not used, just connected so that we do not get errors
set_property PACKAGE_PIN G14 [get_ports spisel]
set_property IOSTANDARD LVCMOS33 [get_ports spisel]
##Bank = 14, Pin name = IO_L13P_T2_MRCC_14,					Sch name = JB2
#set_property PACKAGE_PIN P15 [get_ports {gpioDisplayEnc[5]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {gpioDisplayEnc[5]}]
##Bank = 14, Pin name = IO_L21N_T3_DQS_A06_D22_14,				Sch name = JB3
#set_property PACKAGE_PIN V11 [get_ports {gpioDisplayEnc[6]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {gpioDisplayEnc[6]}]
##Bank = CONFIG, Pin name = IO_L16P_T2_CSI_B_14,				Sch name = JB4
#set_property PACKAGE_PIN V15 [get_ports {gpioDisplayEnc[7]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {gpioDisplayEnc[7]}]
#Bank = 15, Pin name = IO_25_15,						Sch name = JB7 int11
set_property PACKAGE_PIN K16 [get_ports {encoder[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {encoder[0]}]
#Bank = CONFIG, Pin name = IO_L15P_T2_DQS_RWR_B_14,				Sch name = JB8 int13
set_property PACKAGE_PIN R16 [get_ports {encoder[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {encoder[1]}]
#Bank = 14, Pin name = IO_L24P_T3_A01_D17_14,					Sch name = JB9 int14	
set_property PACKAGE_PIN T9 [get_ports {encoder[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {encoder[2]}]
#Bank = 14, Pin name = IO_L19N_T3_A09_D25_VREF_14,				Sch name = JB10 int15 
set_property PACKAGE_PIN U11 [get_ports {encoder[3]}]
...
set_property PACKAGE_PIN K2 [get_ports {testModule1[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {testModule1[0]}]
#Bank = 35, Pin name = IO_L6P_T0_35,						Sch name = JC2
set_property PACKAGE_PIN E7 [get_ports {testModule1[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {testModule1[1]}]
#Bank = 35, Pin name = IO_L22P_T3_35,						Sch name = JC3
set_property PACKAGE_PIN J3 [get_ports {testModule1[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {testModule1[2]}]
#Bank = 35, Pin name = IO_L21P_T3_DQS_35,					Sch name = JC4
set_property PACKAGE_PIN J4 [get_ports {testModule1[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {testModule1[3]}]
#Bank = 35, Pin name = IO_L23N_T3_35,						Sch name = JC7
set_property PACKAGE_PIN K1 [get_ports {testModule1[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {testModule1[4]}]
#Bank = 35, Pin name = IO_L5P_T0_AD13P_35,					Sch name = JC8
set_property PACKAGE_PIN E6 [get_ports {testModule1[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {testModule1[5]}]
#Bank = 35, Pin name = IO_L22N_T3_35,						Sch name = JC9 sample rdy
set_property PACKAGE_PIN J2 [get_ports sample_ready_port]
set_property IOSTANDARD LVCMOS33 [get_ports sample_ready_port]
#Bank = 35, Pin name = IO_L19P_T3_35,						Sch name = JC10 this is gonna be the chunk rdy signal from the buffer
set_property PACKAGE_PIN G6 [get_ports chunk_ready_port]
set_property IOSTANDARD LVCMOS33 [get_ports chunk_ready_port]



##Pmod Header JD
#Bank = 35, Pin name = IO_L21N_T2_DQS_35,					Sch name = JD1
set_property PACKAGE_PIN H4 [get_ports {testModule2[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {testModule2[0]}]
#Bank = 35, Pin name = IO_L17P_T2_35,						Sch name = JD2
set_property PACKAGE_PIN H1 [get_ports {testModule2[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {testModule2[1]}]
#Bank = 35, Pin name = IO_L17N_T2_35,						Sch name = JD3
set_property PACKAGE_PIN G1 [get_ports {testModule2[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {testModule2[2]}]
#Bank = 35, Pin name = IO_L20N_T3_35,						Sch name = JD4
set_property PACKAGE_PIN G3 [get_ports {testModule2[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {testModule2[3]}]
#Bank = 35, Pin name = IO_L15P_T2_DQS_35,					Sch name = JD7
set_property PACKAGE_PIN H2 [get_ports {testModule2[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {testModule2[4]}]
#Bank = 35, Pin name = IO_L20P_T3_35,						Sch name = JD8
set_property PACKAGE_PIN G4 [get_ports {testModule2[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {testModule2[5]}]
...
set_property MARK_DEBUG false [get_nets {spii[astart]}]
set_property MARK_DEBUG false [get_nets {spii[cstart]}]
set_property MARK_DEBUG false [get_nets {spii[ignore]}]
set_property MARK_DEBUG false [get_nets {spio[ssn][7]}]
set_property MARK_DEBUG false [get_nets {spio[ssn][6]}]
set_property MARK_DEBUG false [get_nets {spio[ssn][5]}]
set_property MARK_DEBUG false [get_nets {spio[ssn][4]}]
set_property MARK_DEBUG false [get_nets {spio[ssn][3]}]
set_property MARK_DEBUG false [get_nets {spio[ssn][2]}]
set_property MARK_DEBUG false [get_nets {spio[ssn][1]}]
set_property MARK_DEBUG false [get_nets {spio[ssn][0]}]
set_property MARK_DEBUG false [get_nets {spio[aready]}]
set_property MARK_DEBUG false [get_nets {spio[astart]}]
set_property MARK_DEBUG false [get_nets {spio[enable]}]
set_property MARK_DEBUG false [get_nets {spii[spisel]}]
set_property MARK_DEBUG false [get_nets {spio[misooen]}]
set_property MARK_DEBUG false [get_nets {spio[mosioen]}]
...
connect_debug_port u_ila_0/probe0 [get_nets [list {spii[miso]}]]
create_debug_port u_ila_0 probe
set_property port_width 1 [get_debug_ports u_ila_0/probe1]
connect_debug_port u_ila_0/probe1 [get_nets [list {spii[mosi]}]]
create_debug_port u_ila_0 probe
set_property port_width 1 [get_debug_ports u_ila_0/probe2]
connect_debug_port u_ila_0/probe2 [get_nets [list {spii[sck]}]]
create_debug_port u_ila_0 probe
set_property port_width 1 [get_debug_ports u_ila_0/probe3]
connect_debug_port u_ila_0/probe3 [get_nets [list {spio[mosi]}]]
create_debug_port u_ila_0 probe
set_property port_width 1 [get_debug_ports u_ila_0/probe4]
connect_debug_port u_ila_0/probe4 [get_nets [list {spio[sck]}]]
