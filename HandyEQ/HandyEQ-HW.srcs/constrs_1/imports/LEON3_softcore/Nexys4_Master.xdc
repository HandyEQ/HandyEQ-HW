...
#Bank = 35, Pin name = IO_L22N_T3_35,						Sch name = JC9 signal_768
set_property PACKAGE_PIN J2 [get_ports Buffer_irq]
set_property IOSTANDARD LVCMOS33 [get_ports Buffer_irq]
#Bank = 35, Pin name = IO_L19P_T3_35,						Sch name = JC10 signal_48
set_property PACKAGE_PIN G6 [get_ports signal_48]
set_property IOSTANDARD LVCMOS33 [get_ports signal_48]
...
set_property PACKAGE_PIN G2 [get_ports signal_768]					
set_property IOSTANDARD LVCMOS33 [get_ports signal_768]
...
set_property PACKAGE_PIN K17 [get_ports QspiSDI]				
	set_property IOSTANDARD LVCMOS33 [get_ports QspiSDI]
#Bank = CONFIG, Pin name = IO_L1N_T0_D01_DIN_14,			Sch name = QSPI_DQ1
set_property PACKAGE_PIN K18 [get_ports QspiSDO]				
	set_property IOSTANDARD LVCMOS33 [get_ports QspiSDO]
