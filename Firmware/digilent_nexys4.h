// This file is a header containing board specific pin assignments and function prototypes

/* Define to prevent recursive inclusion -------------------------------------*/
#ifndef _NEXYS4BRD_H
#define _NEXYS4BRD_H

// defines to make assertions possible if a safer version is needed
...
/* --------------- GPIOB ------------------------ */
/* Fixed inputs:  buttons, encoder board  ------- */
/* Fixed outputs: three-color LEDs, OLED -------- */
/* Configurable inputs/outputs: JD, JC ---------- */
